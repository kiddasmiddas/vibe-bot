...
# Вариант для регистрации: анкета не блокируется, юзер продолжает шаги.
SENT_TO_MOD_CONTINUE = (
    "Спасибо! Фото отправлены модератору — как только вайб подберут, "
    "я пришлю результат сюда.\n\nА пока продолжим создание анкеты 👇"
)
...
NEED_PROFILE = "Сначала создай анкету — вайб подбирается для неё."
ALREADY_PENDING = "Твоя заявка уже у модератора — дождись результата, я пришлю его сюда."
