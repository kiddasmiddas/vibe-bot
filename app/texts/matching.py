...
# Гард: вайб ещё подбирает модератор («Вайб по фото») — поиск закрыт.
VIBE_PENDING_GUARD = (
    "⏳ Модератор ещё не выдал тебе вайб.\n\n"
    "Можно подождать — я пришлю уведомление, как только вайб назначат. "
    "Или выбери вайб самостоятельно прямо сейчас."
)
BTN_VIBE_PENDING_BACK = "↩️ Назад"
BTN_VIBE_PENDING_PICK_SELF = "🎨 Выбрать вайб самостоятельно"
VIBE_PENDING_BACK_OK = "Хорошо, подождём модератора. Загляни в поиск позже."
