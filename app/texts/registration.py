...
# В карточке вайб показываем с названием: номер оставляем — по нему юзеры
# выбирают вайб в пикере регистрации (клиент просил видеть название, 2026-07).
RENDER_VIBE_NUMBER = "№{number} · {title}"
